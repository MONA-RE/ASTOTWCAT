...
/**
 * \file    test/phpunit/AddspenttimeontaskwhencloseagendataskFunctionalTest.php
...
/**
 * Class AddspenttimeontaskwhencloseagendataskFunctionalTest
 *
 ...
 *
 * @package Testaddspenttimeontaskwhencloseagendatask
 */
class AddspenttimeontaskwhencloseagendataskFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modAddspenttimeontaskwhencloseagendatask')->click();
		} else {
			// Disable the module
			$this->byHref('modAddspenttimeontaskwhencloseagendatask')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/addspenttimeontaskwhencloseagendatask/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('addspenttimeontaskwhencloseagendatask/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/addspenttimeontaskwhencloseagendatask/admin/about.php');
		$this->authenticate();
		return $this->assertContains('addspenttimeontaskwhencloseagendatask/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('addspenttimeontaskwhencloseagendataskwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAddspenttimeontaskwhencloseagendatask_AddspenttimeontaskwhencloseagendataskTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAddspenttimeontaskwhencloseagendatask_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
